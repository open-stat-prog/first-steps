...
Although doing so is not usually necessary, you can also download R packages from several other repositories, in
addition to CRAN. The following are some population non-CRAN package repositories.
