...
We use the carret character, `^`, to specify exponents. The following code will square and cube the value of `y`.
...
The `sqrt()` function returns the square root of it's argument (i.e., the value we specify inside the parantheses). The
