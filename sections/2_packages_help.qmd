...
- [Usage] Shows how to call the function
   - The functions name
...
- [Arguments] Briefly explains each function argument
- [Details] Provides additional details of function arguments or the functions behavior
- [Value] Describes the object returned by the function
- [Examples] Executible R code demonstrating the functions use
